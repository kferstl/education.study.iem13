...
namespace Testinvi.TweetinviControllers.SearchTests
{
    ...
    public class SearchQueryGeneratorTests
    {
        ...
        public void TestInitialize()
        {
            ...
            _fakeSearchQueryValidator.CallsTo(x => x.IsSearchParameterValid(_tweetSearchParameters)).Returns(true);
            _fakeSearchQueryValidator.CallsTo(x => x.IsSearchQueryValid(_searchQuery)).Returns(true);
        }
        ...
        public void GetSearchTweetQuery_WithTweetSearchParameter_SearchQueryIsInvalid_ReturnsNull()
        {
            // Arrange
            var searchQueryGenerator = CreateSearchQueryGenerator();
            _fakeSearchQueryValidator.CallsTo(x => x.IsSearchQueryValid(_searchQuery)).Returns(false);
        ...
        public void VerifyResultContainsParameters(string result, params string[] expectedParameters)
        {
            int totalLength = 0;
